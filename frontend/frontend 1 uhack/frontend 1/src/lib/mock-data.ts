...
export type StandingRow = {
  pos: number; team: string; p: number; w: number; d: number; l: number; gd: number; pts: number;
};

export const STANDINGS: StandingRow[] = [
  { pos: 1, team: "U Cluj", p: 5, w: 4, d: 0, l: 1, gd: 6, pts: 39 },
  { pos: 2, team: "U Craiova", p: 5, w: 3, d: 0, l: 2, gd: -1, pts: 39 },
  { pos: 3, team: "CFR Cluj", p: 5, w: 2, d: 1, l: 2, gd: -1, pts: 34 },
  { pos: 4, team: "Rapid București", p: 5, w: 2, d: 2, l: 1, gd: -2, pts: 32 },
  { pos: 5, team: "Dinamo București", p: 5, w: 2, d: 2, l: 1, gd: -1, pts: 31 },
  { pos: 6, team: "FC Argeș", p: 5, w: 2, d: 1, l: 2, gd: -1, pts: 30 },
];
